...
/// <summary>
/// jfc: bridges an agent connection's per-job callbacks ("stderr line", "exited") into a
...
public sealed class RemoteJobSink : IRemoteJobSink
{
    ...
    public void OnStderrLine(string line)
    {
        ...
        // jfc: the pipe has PauseWriterThreshold=0 (no backpressure), so this always completes
